...
export default function IntroBackgroundStill() {
  return (
    ...
    >
      ...
      />
      <div
        className="absolute -top-24 left-1/2 h-72 w-72 -translate-x-1/2
          rounded-full bg-cyan-400/10 blur-3xl"
      />
      <div
        className="absolute -bottom-20 left-1/3 h-56 w-56 rounded-full
          bg-fuchsia-400/10 blur-3xl"
      />

      <div
        className="absolute top-1/2 left-1/2 h-[68vmin] max-h-[520px]
          min-h-[280px] w-[68vmin] max-w-[520px] min-w-[280px] -translate-x-1/2
