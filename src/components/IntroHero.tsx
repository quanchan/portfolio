...
export default function IntroHero() {
	return (
		<div className="relative z-10 flex w-full flex-col items-center gap-10 md:flex-row md:items-center md:gap-16">
			{/* Text content */}
			...
			>
				{/* Ambient glow */}
				<div className="absolute -inset-4 rounded-full bg-gradient-to-br from-cyan-500/20 via-indigo-500/15 to-fuchsia-500/20 blur-2xl" />
				<img
					src={portraitSrc}
					alt="Alan Tran"
					width={176}
					height={176}
					className="relative block h-36 w-36 rounded-full object-cover brightness-95 md:h-44 md:w-44"
				/>
			</motion.div>
		</div>
	);
